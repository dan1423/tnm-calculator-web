...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center   p-10" style={{ backgroundColor: '#fff', color: '#000000' }}>
      ...
      <div style={{ padding: 5, width: '50%'}} className='content-start mb-5'>
      <label  className='block mb-2 text-base font-medium text-gray-900 dark:text-white'>Select a Staging Type:</label>
